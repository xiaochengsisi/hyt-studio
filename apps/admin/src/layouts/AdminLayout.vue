...
const menu = [
  ...
  { to: '/topics', label: '专题', icon: 'M3 7h18M3 12h18M3 17h12' },
  { to: '/submissions', label: '提交审核', icon: 'M12 3v12m0 0l-4-4m4 4l4-4M4 21h16' },
  { to: '/media', label: '媒体库', icon: 'M21 19V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2zM8.5 13.5l2.5 3 3.5-4.5 4.5 6H5z' },
  { to: '/subscribers', label: '订阅', icon: 'M22 6l-10 7L2 6M22 6v12a2 2 0 01-2 2H4a2 2 0 01-2-2V6M22 6a2 2 0 00-2-2H4a2 2 0 00-2 2' },
  { to: '/backup', label: '备份', icon: 'M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M7 10l5 5 5-5M12 15V3' },
